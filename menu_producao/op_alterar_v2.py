...
class TelaOpAlterarV2(QMainWindow, Ui_AlteraOP):
    ...
    def define_tabela(self):
        try:
            ...
            for dados_op in op_abertas:
                emissao, op, cod, descr, ref, um, qtde, obs, id_estrutura = dados_op
                ...
                if id_estrutura:
                    ...
                    cursor = conecta.cursor()
                    cursor.execute(f"select count(estprod.id) from estrutura_produto as estprod "
