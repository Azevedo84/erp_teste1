...
# Form implementation generated from reading ui file 'tela_cad_usuario.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_6.setMaximumSize(QtCore.QSize(16777215, 185))
        ...
        self.line_Login = QtWidgets.QLineEdit(self.widget_14)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_Login.sizePolicy().hasHeightForWidth())
        self.line_Login.setSizePolicy(sizePolicy)
        self.line_Login.setMinimumSize(QtCore.QSize(0, 0))
        self.line_Login.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.line_Login.setFont(font)
        self.line_Login.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_Login.setText("")
        self.line_Login.setMaxLength(45)
        ...
        self.horizontalLayout_9.addWidget(self.line_Login)
        ...
        self.line_Email = QtWidgets.QLineEdit(self.widget_17)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_Email.sizePolicy().hasHeightForWidth())
        self.line_Email.setSizePolicy(sizePolicy)
        self.line_Email.setMinimumSize(QtCore.QSize(0, 0))
        self.line_Email.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.horizontalLayout_12.addWidget(self.line_Email)
        ...
        self.combo_Funcionario = QtWidgets.QComboBox(self.widget_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.combo_Funcionario.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.horizontalLayout_4.addWidget(self.combo_Funcionario)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Cadastro de Usuários"))
        self.label_4.setText(_translate("MainWindow", "Código:"))
        self.label_13.setText(_translate("MainWindow", "Cadastro de Usuários"))
        ...
        self.label_6.setText(_translate("MainWindow", "Consulta Login:"))
        self.btn_Consulta.setText(_translate("MainWindow", "Consultar"))
        self.label_5.setText(_translate("MainWindow", "Lista de Usuários"))
