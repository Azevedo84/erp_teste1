...
# Form implementation generated from reading ui file 'tela_cad_natureza.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_CFOP = QtWidgets.QLineEdit(self.widget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_CFOP.sizePolicy().hasHeightForWidth())
        self.line_CFOP.setSizePolicy(sizePolicy)
        self.line_CFOP.setMinimumSize(QtCore.QSize(0, 25))
        self.line_CFOP.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.line_CFOP.setFont(font)
        self.line_CFOP.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_CFOP.setText("")
        self.line_CFOP.setMaxLength(45)
        self.line_CFOP.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.line_CFOP.setObjectName("line_CFOP")
        self.horizontalLayout_5.addWidget(self.line_CFOP)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Cadastro de Naturaza de Operação (CFOP)"))
        self.label_4.setText(_translate("MainWindow", "Código:"))
        self.label_13.setText(_translate("MainWindow", "Cadastro de Natureza de Operação (CFOP)"))
        self.label_11.setText(_translate("MainWindow", "Data Emissao: "))
        self.label_2.setText(_translate("MainWindow", "Dados Cadastro"))
        self.label_25.setText(_translate("MainWindow", "CFOP:"))
        ...
        self.label_5.setText(_translate("MainWindow", "Lista de Natureza de Operação"))
