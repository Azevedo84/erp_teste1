...
# Form implementation generated from reading ui file 'tela_prod_compras.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_Compras.setColumnCount(12)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_Compras.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Compras.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Compras.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Compras.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Compras.setHorizontalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_Compras.setHorizontalHeaderItem(11, item)
        self.verticalLayout_3.addWidget(self.table_Compras)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Compras do Produto"))
        self.label_13.setText(_translate("MainWindow", "Compras do Produto"))
        ...
        item = self.table_Compras.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "R$ TOTAL"))
        item = self.table_Compras.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "EMISSÃO OC"))
        item = self.table_Compras.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "CÓD. FOR."))
        item = self.table_Compras.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "FORNECEDOR"))
        item = self.table_Compras.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "Nº REQ"))
        item = self.table_Compras.horizontalHeaderItem(11)
