...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_9.setMaximumSize(QtCore.QSize(16777215, 68))
        ...
        self.label_78.setMaximumSize(QtCore.QSize(75, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.combo_Func = QtWidgets.QComboBox(self.widget_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combo_Func.sizePolicy().hasHeightForWidth())
        self.combo_Func.setSizePolicy(sizePolicy)
        self.combo_Func.setMinimumSize(QtCore.QSize(0, 0))
        self.combo_Func.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.combo_Func.setFont(font)
        self.combo_Func.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"text-align: center;")
        self.combo_Func.setObjectName("combo_Func")
        self.horizontalLayout_6.addWidget(self.combo_Func)
        ...
        self.combo_Prioridade = QtWidgets.QComboBox(self.widget_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combo_Prioridade.sizePolicy().hasHeightForWidth())
        self.combo_Prioridade.setSizePolicy(sizePolicy)
        self.combo_Prioridade.setMinimumSize(QtCore.QSize(0, 0))
        self.combo_Prioridade.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.combo_Prioridade.setFont(font)
        self.combo_Prioridade.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"text-align: center;")
        self.combo_Prioridade.setObjectName("combo_Prioridade")
        self.horizontalLayout_6.addWidget(self.combo_Prioridade)
        ...
        self.table_Prioridade = QtWidgets.QTableWidget(self.widget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.table_Prioridade.sizePolicy().hasHeightForWidth())
        self.table_Prioridade.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.table_Prioridade.setFont(font)
        self.table_Prioridade.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.table_Prioridade.setObjectName("table_Prioridade")
        self.table_Prioridade.setColumnCount(1)
        self.table_Prioridade.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.table_Prioridade.setHorizontalHeaderItem(0, item)
        self.table_Prioridade.verticalHeader().setDefaultSectionSize(0)
        self.table_Prioridade.verticalHeader().setMinimumSectionSize(0)
        self.verticalLayout_6.addWidget(self.table_Prioridade)
        ...
        self.btn_Excluir_Func = QtWidgets.QPushButton(self.widget_14)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_Excluir_Func.sizePolicy().hasHeightForWidth())
        self.btn_Excluir_Func.setSizePolicy(sizePolicy)
        self.btn_Excluir_Func.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.btn_Excluir_Func.setFont(font)
        self.btn_Excluir_Func.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_Excluir_Func.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.btn_Excluir_Func.setAutoFillBackground(False)
        self.btn_Excluir_Func.setStyleSheet("background-color: rgb(141, 141, 141);")
        self.btn_Excluir_Func.setCheckable(False)
        self.btn_Excluir_Func.setAutoDefault(False)
        self.btn_Excluir_Func.setDefault(False)
        self.btn_Excluir_Func.setFlat(False)
        self.btn_Excluir_Func.setObjectName("btn_Excluir_Func")
        self.horizontalLayout_8.addWidget(self.btn_Excluir_Func)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_78.setText(_translate("MainWindow", "Funcionário:"))
        self.label_79.setText(_translate("MainWindow", "Prioridade:"))
        self.btn_Adicionar.setText(_translate("MainWindow", "Adicionar"))
        self.label_7.setText(_translate("MainWindow", "Lista Prioridade"))
        item = self.table_Prioridade.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "FUNCIONÁRIO"))
        self.btn_Excluir_Func.setText(_translate("MainWindow", "Excluir\n"
"Funcionário"))
